...
function checkData() {
    skinsData = ipcRenderer.sendSync("getClientApi", "/lol-game-data/assets/v1/skins.json");
    champData = ipcRenderer.sendSync("getClientApi", "/lol-game-data/assets/v1/champion-summary.json");
